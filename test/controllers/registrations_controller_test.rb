...
class Contour::RegistrationsControllerTest < ActionController::TestCase
  ...
  test 'a new user should be able to sign up' do
    assert_difference('User.count') do
      post :create, params: { user: { first_name: 'First Name', last_name: 'Last Name', email: 'new_user@example.com', password: 'password', password_confirmation: 'password', spam: '' } }
    end
  ...
  test 'a new user should not be able to set their status' do
    assert_difference('User.count') do
      post :create, params: { user: { first_name: 'First Name', last_name: 'Last Name', status: 'active', email: 'new_registration@example.com', password: 'password', password_confirmation: 'password' } }
    end
  ...
  test 'a submitter spam bot should not be able to sign up' do
    assert_difference('User.count', 0) do
      post :create, params: { user: { first_name: 'First Name', last_name: 'Last Name', email: 'new_user@example.com', password: 'password', password_confirmation: 'password', spam: 'http://buystuffhere.com' } }
    end
